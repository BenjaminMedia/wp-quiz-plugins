		...
		<div id="wpvqgr-<?php echo $wpvqgr_quiz->getId(); ?>" class="wpvqgr <?php echo $wpvqgr_quiz->getType(); ?>">
			...
			<?php if (!$wpvqgr_resultsOnly): ?>
				...
				<div class="wpvqgr-page-0 wpvqgr-page" data-id="0">
					...
					<?php 	
						$wpvqgr_questions = $wpvqgr_quiz->getQuestions();
						foreach($wpvqgr_questions as $q_id => $question):

							$q_disposition 		=  'line'; // or square
							$q_label 			=  $question['wpvqgr_quiz_questions_content'];
					...
					?>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="wpvqgr-question wpvqgr-<?php echo $q_disposition; ?>" data-id="<?php echo $q_id; ?>">
									<div class="wpvqgr-question-label"><?php echo do_shortcode(nl2br($q_label)); ?></div>
												...
												<div class="wpvqgr-answer-col col-xs-<?php echo $smartColumns['xs-size']; ?> col-md-<?php echo $smartColumns['md-size']; ?>">
													<div class="wpvqgr-answer" data-id="<?php echo $a_id; ?>">
														...
														<div class="wpvqgr-checkbox">
															<img class="wpvqgr-checkbox-picture" src="<?php echo $wpvqgr_skin_dir_url . 'checkbox-unchecked.jpg'; ?>" />
					...
					<div class="wpvqgr-askinfo">
						...
						<form action="" method="GET">
							...
							<div class="form-group" style="text-align:center;">
								<button type="submit" class="wpvqgr-button"><?php echo $wpvqgr_quiz->getSetting('customlabel_askinfobutton'); ?></button>
							</div>
						</form>
