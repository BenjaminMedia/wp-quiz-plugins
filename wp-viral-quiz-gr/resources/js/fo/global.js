...
{ 
		...
		wpvqgr.actionsBeforeResults = function()
		{
			...
			if (!wpvqgr_results_only) 
			{
				...
				if (wpvqgr_quiz.settings.redirect) {
					wpvqgr.showLoader();
					wpvqgr.redirect(wpvqgr_results_url);	
					return;
				}
			}
		...
		wpvqgr.parseResults = function(tag, value) 
		{
			...
			{
				// Facebook
				var $facebookButton = $('button.wpvqgr-button.wpvqgr-social-facebook');
				if ($facebookButton.length > 0)
				{
					...
					$('button.wpvqgr-button.wpvqgr-social-facebook').attr('data-title', facebook_title)
					$('button.wpvqgr-button.wpvqgr-social-facebook').attr('data-description', facebook_description)
				}
