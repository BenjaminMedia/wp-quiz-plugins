...
class WPVQShortcode {
	...
	*/
	public static function viralQuiz($param) 
	{
		...
		$wpdata['quiz'] = $q;
		$wpdata['type'] = $type;
// add extra param to shortcode		
		$wpdata['top'] = ($param['top']);
		$wpdata['lang'] = ($param['lang']);
		$wpdata['form'] = ($param['form']);
		$wpdata['formname'] = ($param['formname']);
		$wpdata['fbperm'] = ($param['fbperm']);
		$wpdata['perm'] = ($param['perm']);
