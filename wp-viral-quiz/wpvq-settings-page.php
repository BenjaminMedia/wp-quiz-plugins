<?php
	...
	function wpvq_settings_init() { 
		...
		// Norwegean translation
		add_settings_field( 
			'wpvq_text_field_share_local_TRIVIA_no', 
			__('Text on your page<br />(below the quiz) :', 'wpvq'),
			'wpvq_text_field_share_local_TRIVIA_render_no', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_simple_TRIVIA_no', 
			__('Content for Twitter :', 'wpvq'),
			'wpvq_text_field_share_simple_TRIVIA_render_no', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_facebook_title_TRIVIA_no', 
			__('Content for Facebook Title :', 'wpvq'),
			'wpvq_text_field_share_facebook_title_TRIVIA_render_no', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_facebook_desc_TRIVIA_no', 
			__('Content for Facebook Description :', 'wpvq'),
			'wpvq_text_field_share_facebook_desc_TRIVIA_render_no', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);
       ...
       // Swedish translation
		add_settings_field( 
			'wpvq_text_field_share_local_TRIVIA_se', 
			__('Text on your page<br />(below the quiz) :', 'wpvq'),
			'wpvq_text_field_share_local_TRIVIA_render_se', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_simple_TRIVIA_se', 
			__('Content for Twitter :', 'wpvq'),
			'wpvq_text_field_share_simple_TRIVIA_render_se', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_facebook_title_TRIVIA_se', 
			__('Content for Facebook Title :', 'wpvq'),
			'wpvq_text_field_share_facebook_title_TRIVIA_render_se', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_facebook_desc_TRIVIA_se', 
			__('Content for Facebook Description :', 'wpvq'),
			'wpvq_text_field_share_facebook_desc_TRIVIA_render_se', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);
		// Finnish translation
		add_settings_field( 
			'wpvq_text_field_share_local_TRIVIA_fi', 
			__('Text on your page<br />(below the quiz) :', 'wpvq'),
			'wpvq_text_field_share_local_TRIVIA_render_fi', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_simple_TRIVIA_fi', 
			__('Content for Twitter :', 'wpvq'),
			'wpvq_text_field_share_simple_TRIVIA_render_fi', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_facebook_title_TRIVIA_fi', 
			__('Content for Facebook Title :', 'wpvq'),
			'wpvq_text_field_share_facebook_title_TRIVIA_render_fi', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);

		add_settings_field( 
			'wpvq_text_field_share_facebook_desc_TRIVIA_fi', 
			__('Content for Facebook Description :', 'wpvq'),
			'wpvq_text_field_share_facebook_desc_TRIVIA_render_fi', 
			'wpvqSettings_shareTrivia', 
			'wpvq_wpvqSettings_networking_sharebox_settings_TRIVIA' 
		);
	...
	function wpvq_settings_sharebox_section_TRIVIA_callback() { 
		...
		echo "<ul class=\"wpvq-tags-list\">";
			...
			// echo "<li><strong>%%quizlink%%</strong> : ".__('will be replaced by the url of the quiz', 'wpvq')."</li>";
		echo "</ul>";
		echo "<span style='color:red'>OBS: Ændringer her under er globale og slår ignennem på alle quizer!</span>";
	}
	...
	function wpvq_text_field_share_local_TRIVIA_render() {
		...
		?>
			DK <input type="text" value="<?php echo $localSharebox; ?>" name="wpvq_settings[wpvq_text_field_share_local_TRIVIA]" style="width:600px;" />
		<?php
	}
	// NO
	function wpvq_text_field_share_local_TRIVIA_render_no() {
		$options 		 =  get_option( 'wpvq_settings' );
		$localSharebox_no  =  (isset($options['wpvq_text_field_share_local_TRIVIA_no']) && !empty($options['wpvq_text_field_share_local_TRIVIA_no'])) ? $options['wpvq_text_field_share_local_TRIVIA_no']:WPVQ_SHARE_TRIVIA_LOCAL;
		?>
			NO <input type="text" value="<?php echo $localSharebox_no; ?>" name="wpvq_settings[wpvq_text_field_share_local_TRIVIA_no]" style="width:600px;" />
		<?php
	}
	// SE
	function wpvq_text_field_share_local_TRIVIA_render_se() {
		$options 		 =  get_option( 'wpvq_settings' );
		$localSharebox_se  =  (isset($options['wpvq_text_field_share_local_TRIVIA_se']) && !empty($options['wpvq_text_field_share_local_TRIVIA_se'])) ? $options['wpvq_text_field_share_local_TRIVIA_se']:WPVQ_SHARE_TRIVIA_LOCAL;
		?>
			SE <input type="text" value="<?php echo $localSharebox_se; ?>" name="wpvq_settings[wpvq_text_field_share_local_TRIVIA_se]" style="width:600px;" />
		<?php
	}
	// FI
	function wpvq_text_field_share_local_TRIVIA_render_fi() {
		$options 		 =  get_option( 'wpvq_settings' );
		$localSharebox_fi  =  (isset($options['wpvq_text_field_share_local_TRIVIA_fi']) && !empty($options['wpvq_text_field_share_local_TRIVIA_fi'])) ? $options['wpvq_text_field_share_local_TRIVIA_fi']:WPVQ_SHARE_TRIVIA_LOCAL;
		?>
			FI <input type="text" value="<?php echo $localSharebox_fi; ?>" name="wpvq_settings[wpvq_text_field_share_local_TRIVIA_fi]" style="width:600px;" />
		<?php
	}
	...
	function wpvq_text_field_share_simple_TRIVIA_render() {
		...
		?>
			DK <input type="text" value="<?php echo $simpleSharebox; ?>" name="wpvq_settings[wpvq_text_field_share_simple_TRIVIA]" style="width:600px;" />
		<?php
	}
	
	// NO
	function wpvq_text_field_share_simple_TRIVIA_render_no() {
		$options 		 =  get_option( 'wpvq_settings' );
		$simpleSharebox_no  =  (isset($options['wpvq_text_field_share_simple_TRIVIA_no']) && !empty($options['wpvq_text_field_share_simple_TRIVIA_no'])) ? $options['wpvq_text_field_share_simple_TRIVIA_no']:WPVQ_SHARE_TRIVIA_SIMPLE;
		?>
			NO <input type="text" value="<?php echo $simpleSharebox_no; ?>" name="wpvq_settings[wpvq_text_field_share_simple_TRIVIA_no]" style="width:600px;" />
		<?php
	}
	// SE
	function wpvq_text_field_share_simple_TRIVIA_render_se() {
		$options 		 =  get_option( 'wpvq_settings' );
		$simpleSharebox_se  =  (isset($options['wpvq_text_field_share_simple_TRIVIA_se']) && !empty($options['wpvq_text_field_share_simple_TRIVIA_se'])) ? $options['wpvq_text_field_share_simple_TRIVIA_se']:WPVQ_SHARE_TRIVIA_SIMPLE;
		?>
			SE <input type="text" value="<?php echo $simpleSharebox_se; ?>" name="wpvq_settings[wpvq_text_field_share_simple_TRIVIA_se]" style="width:600px;" />
		<?php
	}
	// FI
	function wpvq_text_field_share_simple_TRIVIA_render_fi() {
		$options 		 =  get_option( 'wpvq_settings' );
		$simpleSharebox_fi  =  (isset($options['wpvq_text_field_share_simple_TRIVIA_fi']) && !empty($options['wpvq_text_field_share_simple_TRIVIA_fi'])) ? $options['wpvq_text_field_share_simple_TRIVIA_fi']:WPVQ_SHARE_TRIVIA_SIMPLE;
		?>
			FI <input type="text" value="<?php echo $simpleSharebox_fi; ?>" name="wpvq_settings[wpvq_text_field_share_simple_TRIVIA_fi]" style="width:600px;" />
		<?php
	}
	...
	function wpvq_text_field_share_facebook_title_TRIVIA_render() {
		...
		?>
			DK <input type="text" value="<?php echo $fbTitle; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_title_TRIVIA]" style="width:600px;" />
		<?php
	}
	// NO
	function wpvq_text_field_share_facebook_title_TRIVIA_render_no() {
		$options 		=  get_option( 'wpvq_settings' );
		$fbTitle_no 		=  (isset($options['wpvq_text_field_share_facebook_title_TRIVIA_no']) && !empty($options['wpvq_text_field_share_facebook_title_TRIVIA_no'])) ? $options['wpvq_text_field_share_facebook_title_TRIVIA_no']:WPVQ_SHARE_TRIVIA_FB_TITLE;
		?>
			NO <input type="text" value="<?php echo $fbTitle_no; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_title_TRIVIA_no]" style="width:600px;" />
		<?php
	}
	// SE
	function wpvq_text_field_share_facebook_title_TRIVIA_render_se() {
		$options 		=  get_option( 'wpvq_settings' );
		$fbTitle_se 		=  (isset($options['wpvq_text_field_share_facebook_title_TRIVIA_se']) && !empty($options['wpvq_text_field_share_facebook_title_TRIVIA_se'])) ? $options['wpvq_text_field_share_facebook_title_TRIVIA_se']:WPVQ_SHARE_TRIVIA_FB_TITLE;
		?>
			SE <input type="text" value="<?php echo $fbTitle_se; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_title_TRIVIA_se]" style="width:600px;" />
		<?php
	}
	// FI
	function wpvq_text_field_share_facebook_title_TRIVIA_render_FI() {
		$options 		=  get_option( 'wpvq_settings' );
		$fbTitle_fi 		=  (isset($options['wpvq_text_field_share_facebook_title_TRIVIA_fi']) && !empty($options['wpvq_text_field_share_facebook_title_TRIVIA_fi'])) ? $options['wpvq_text_field_share_facebook_title_TRIVIA_fi']:WPVQ_SHARE_TRIVIA_FB_TITLE;
		?>
			FI <input type="text" value="<?php echo $fbTitle_fi; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_title_TRIVIA_fi]" style="width:600px;" />
		<?php
	}
	...
	function wpvq_text_field_share_facebook_desc_TRIVIA_render() {
		...
		?>
			DK <input type="text" value="<?php echo $fbTitle; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_desc_TRIVIA]" style="width:600px;" />
		<?php
	}
    // NO
    function wpvq_text_field_share_facebook_desc_TRIVIA_render_no() {
		$options 		=  get_option( 'wpvq_settings' );
		$fbTitle_no 		=  (isset($options['wpvq_text_field_share_facebook_desc_TRIVIA_no']) && !empty($options['wpvq_text_field_share_facebook_desc_TRIVIA_no'])) ? $options['wpvq_text_field_share_facebook_desc_TRIVIA_no']:WPVQ_SHARE_TRIVIA_FB_DESC;
		?>
			NO <input type="text" value="<?php echo $fbTitle_no; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_desc_TRIVIA_no]" style="width:600px;" />
		<?php
	}
	// SE
    function wpvq_text_field_share_facebook_desc_TRIVIA_render_se() {
		$options 		=  get_option( 'wpvq_settings' );
		$fbTitle_se 		=  (isset($options['wpvq_text_field_share_facebook_desc_TRIVIA_se']) && !empty($options['wpvq_text_field_share_facebook_desc_TRIVIA_se'])) ? $options['wpvq_text_field_share_facebook_desc_TRIVIA_se']:WPVQ_SHARE_TRIVIA_FB_DESC;
		?>
			SE <input type="text" value="<?php echo $fbTitle_se; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_desc_TRIVIA_se]" style="width:600px;" />
		<?php
	}
	// FI
    function wpvq_text_field_share_facebook_desc_TRIVIA_render_fi() {
		$options 		=  get_option( 'wpvq_settings' );
		$fbTitle_fi 		=  (isset($options['wpvq_text_field_share_facebook_desc_TRIVIA_fi']) && !empty($options['wpvq_text_field_share_facebook_desc_TRIVIA_fi'])) ? $options['wpvq_text_field_share_facebook_desc_TRIVIA_fi']:WPVQ_SHARE_TRIVIA_FB_DESC;
		?>
			FI <input type="text" value="<?php echo $fbTitle_fi; ?>" name="wpvq_settings[wpvq_text_field_share_facebook_desc_TRIVIA_fi]" style="width:600px;" />
		<?php
	}
	...
	function wp_viral_quiz_options_page() { 
		...
		<div class="wrap">
			...
			<div id="wpvq-fixed-settings-menu">
				...
				<p>
					First, <a href="https://www.institut-pandore.com/wp-viral-quiz/faq/" target="_blank">read the FAQ (click here) !</a>
					<br />You'll discover a lot of things and most of cases, <strong>your problem was already explained ! :)</strong></li>
				</p>
				<p>
					If you don't find any solution, <a href="https://www.institut-pandore.com/wp-viral-quiz/support/" target="_blank">feel free to contact me</a>.
				</p>
			</div>
