...
?>
						<?php echo $sharelabel; /* apply_filters('wpvq_share_results_label', __('Share your results', 'wpvq')); */ ?>
					</p>
					...
					<?php if ($wpvq_networks_display['twitter']): ?>
						<a href="http://twitter.com/share?url=<?php echo get_permalink(); ?>&text=<?php echo $twitterText; ?>&hashtags=<?php echo $wpvq_twitter_hashtag; ?>&mention=<?php echo $wpvq_twitter_mention; ?>" target="_blank" class="wpvq-js-loop wpvq-twitter-share-popup">
