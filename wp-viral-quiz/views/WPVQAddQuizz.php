									...
									<tr>
										...
										<td>
											<label for="wpvq-redirectionPage">
												...
												<a href="https://www.institut-pandore.com/wp-viral-quiz/redirection-result-page/" target="_blank"><?php _e("More info here.", 'wpvq'); ?></a>
											</label>
										</td>
									</tr>
										...
										<tr style="border-top:1px dashed #dedede;">
											...
											<td>
												<label for="wpvq-hideRightWrong">
													<input type="checkbox" id="wpvq-hideRightWrong" name="hideRightWrong" value="1" <?php if ($vqData['meta']['hideRightWrong']): ?>checked="checked"<?php endif; ?> />
								...
								<div data-section="1">
									...
									<div class="wpvq-settings-askinfo-mailchimp-content" wpvq-data-section="1">
										<div class="wpvq-onoffswitch" data-select-sub-section="1">
										    ...
										    <span style="float:right;"><a href="https://www.institut-pandore.com/wp-viral-quiz/mailchimp-sync/" target="_blank"><?php _e("(Learn to configure) ", 'wpvq'); ?></a></span>
										</div>
													...
													<tr>
														...
														<td>
															<label for="mailchimp_firstNameField">
																<input type="text" id="wpvq-mailchimp-firstNameField" name="mailchimp_firstNameField" value="<?php echo isset($vqData['meta']['mailchimp']['firstNameField']) ? $vqData['meta']['mailchimp']['firstNameField']:''; ?>" placeholder="placeholder="<?php _e("Optional", 'wpvq'); ?>" style="width:270px;" />												
															</label>
														</td>
													</tr>
													<tr>
														...
														<td>
															<label for="mailchimp_resultField">
																<input type="text" id="wpvq-mailchimp-resultField" name="mailchimp_resultField" value="<?php echo isset($vqData['meta']['mailchimp']['resultField']) ? $vqData['meta']['mailchimp']['resultField']:''; ?>" placeholder="placeholder="<?php _e("Optional", 'wpvq'); ?>" style="width:270px;" />												
															</label>
														</td>
													</tr>
													<tr>
									...
									<div class="wpvq-settings-askinfo-aweber-content" wpvq-data-section="2">
										<div class="wpvq-onoffswitch" data-select-sub-section="2">
										    ...
										    <span style="float:right;"><a href="https://www.institut-pandore.com/wp-viral-quiz/aweber-sync/" target="_blank"><?php _e("(Learn to configure)", 'wpvq'); ?></a></span>
										</div>
