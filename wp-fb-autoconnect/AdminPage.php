...
function jfb_admin_page()
{
    ...
    global $opt_jfb_ask_perms_email, $opt_jfb_ask_perms_about, $opt_jfb_ask_perms_books, $opt_jfb_ask_perms_fitness, $opt_jfb_ask_perms_music, $opt_jfb_ask_perms_news, $opt_jfb_ask_perms_birthday, $opt_jfb_ask_perms_education, $opt_jfb_ask_perms_hometown, $opt_jfb_ask_perms_photos, $opt_jfb_ask_perms_posts, $opt_jfb_ask_perms_relationsship, $opt_jfb_ask_perms_relationsshipdetails, $opt_jfb_ask_perms_religionpolitics, $opt_jfb_ask_perms_videos, $opt_jfb_ask_perms_adsread, $opt_jfb_ask_perms_places, $opt_jfb_ask_perms_friends, $opt_jfb_ask_perms_videoactions, $opt_jfb_ask_perms_events, $opt_jfb_ask_perms_games, $opt_jfb_ask_perms_likes, $opt_jfb_ask_perms_location, $opt_jfb_ask_perms_groups, $opt_jfb_ask_perms_websites, $opt_jfb_ask_perms_work, $opt_jfb_ask_perms_customfreinds;
    global $opt_jfb_mod_done, $opt_jfb_ask_stream, $opt_jfb_stream_content;
    ...
    {
        $shownTab = 1;
        update_option( $opt_jfb_ask_perms_email, esc_html( isset( $_POST[$opt_jfb_ask_perms_email] ) ? $_POST[$opt_jfb_ask_perms_email] : 0 ) );
        update_option( $opt_jfb_ask_perms_about, esc_html( isset( $_POST[$opt_jfb_ask_perms_about] ) ? $_POST[$opt_jfb_ask_perms_about] : 0 ) );
        update_option( $opt_jfb_ask_perms_books, esc_html( isset( $_POST[$opt_jfb_ask_perms_books] ) ? $_POST[$opt_jfb_ask_perms_books] : 0 ) );
        update_option( $opt_jfb_ask_perms_fitness, esc_html( isset( $_POST[$opt_jfb_ask_perms_fitness] ) ? $_POST[$opt_jfb_ask_perms_fitness] : 0 ) );
        update_option( $opt_jfb_ask_perms_music, esc_html( isset( $_POST[$opt_jfb_ask_perms_music] ) ? $_POST[$opt_jfb_ask_perms_music] : 0 ) );
        update_option( $opt_jfb_ask_perms_news, esc_html( isset( $_POST[$opt_jfb_ask_perms_news] ) ? $_POST[$opt_jfb_ask_perms_news] : 0 ) );
        update_option( $opt_jfb_ask_perms_birthday, esc_html( isset( $_POST[$opt_jfb_ask_perms_birthday] ) ? $_POST[$opt_jfb_ask_perms_birthday] : 0 ) );
        update_option( $opt_jfb_ask_perms_education, esc_html( isset( $_POST[$opt_jfb_ask_perms_education] ) ? $_POST[$opt_jfb_ask_perms_education] : 0 ) );
        update_option( $opt_jfb_ask_perms_hometown, esc_html( isset( $_POST[$opt_jfb_ask_perms_hometown] ) ? $_POST[$opt_jfb_ask_perms_hometown] : 0 ) );
        update_option( $opt_jfb_ask_perms_photos, esc_html( isset( $_POST[$opt_jfb_ask_perms_photos] ) ? $_POST[$opt_jfb_ask_perms_photos] : 0 ) );
        update_option( $opt_jfb_ask_perms_posts, esc_html( isset( $_POST[$opt_jfb_ask_perms_posts] ) ? $_POST[$opt_jfb_ask_perms_posts] : 0 ) );
        update_option( $opt_jfb_ask_perms_relationsship, esc_html( isset( $_POST[$opt_jfb_ask_perms_relationsship] ) ? $_POST[$opt_jfb_ask_perms_relationsship] : 0 ) );
        update_option( $opt_jfb_ask_perms_relationsshipdetails, esc_html( isset( $_POST[$opt_jfb_ask_perms_relationsshipdetails] ) ? $_POST[$opt_jfb_ask_perms_relationsshipdetails] : 0 ) );
        update_option( $opt_jfb_ask_perms_religionpolitics, esc_html( isset( $_POST[$opt_jfb_ask_perms_religionpolitics] ) ? $_POST[$opt_jfb_ask_perms_religionpolitics] : 0 ) );
        update_option( $opt_jfb_ask_perms_videos, esc_html( isset( $_POST[$opt_jfb_ask_perms_videos] ) ? $_POST[$opt_jfb_ask_perms_videos] : 0 ) );
        update_option( $opt_jfb_ask_perms_adsread, esc_html( isset( $_POST[$opt_jfb_ask_perms_adsread] ) ? $_POST[$opt_jfb_ask_perms_adsread] : 0 ) );
        update_option( $opt_jfb_ask_perms_places, esc_html( isset( $_POST[$opt_jfb_ask_perms_places] ) ? $_POST[$opt_jfb_ask_perms_places] : 0 ) );
        update_option( $opt_jfb_ask_perms_friends, esc_html( isset( $_POST[$opt_jfb_ask_perms_friends] ) ? $_POST[$opt_jfb_ask_perms_friends] : 0 ) );
        update_option( $opt_jfb_ask_perms_videoactions, esc_html( isset( $_POST[$opt_jfb_ask_perms_videoactions] ) ? $_POST[$opt_jfb_ask_perms_videoactions] : 0 ) );
        update_option( $opt_jfb_ask_perms_events, esc_html( isset( $_POST[$opt_jfb_ask_perms_events] ) ? $_POST[$opt_jfb_ask_perms_events] : 0 ) );
        update_option( $opt_jfb_ask_perms_games, esc_html( isset( $_POST[$opt_jfb_ask_perms_games] ) ? $_POST[$opt_jfb_ask_perms_games] : 0 ) );
        update_option( $opt_jfb_ask_perms_likes, esc_html( isset( $_POST[$opt_jfb_ask_perms_likes] ) ? $_POST[$opt_jfb_ask_perms_likes] : 0 ) );
        update_option( $opt_jfb_ask_perms_location, esc_html( isset( $_POST[$opt_jfb_ask_perms_location] ) ? $_POST[$opt_jfb_ask_perms_location] : 0 ) );
        update_option( $opt_jfb_ask_perms_groups, esc_html( isset( $_POST[$opt_jfb_ask_perms_groups] ) ? $_POST[$opt_jfb_ask_perms_groups] : 0 ) );
        update_option( $opt_jfb_ask_perms_websites, esc_html( isset( $_POST[$opt_jfb_ask_perms_websites] ) ? $_POST[$opt_jfb_ask_perms_websites] : 0 ) );
        update_option( $opt_jfb_ask_perms_work, esc_html( isset( $_POST[$opt_jfb_ask_perms_work] ) ? $_POST[$opt_jfb_ask_perms_work] : 0 ) );
        update_option( $opt_jfb_ask_perms_customfreinds, esc_html( isset( $_POST[$opt_jfb_ask_perms_customfreinds] ) ? $_POST[$opt_jfb_ask_perms_customfreinds] : 0 ) );
    ...
    if( isset($_POST['remove_all_settings']) )
    {
        ...
        delete_option($opt_jfb_ask_perms_email);
        delete_option($opt_jfb_ask_perms_about);
        delete_option($opt_jfb_ask_perms_books);
        delete_option($opt_jfb_ask_perms_fitness);
        delete_option($opt_jfb_ask_perms_music);
        delete_option($opt_jfb_ask_perms_news);
        delete_option($opt_jfb_ask_perms_birthday);
        delete_option($opt_jfb_ask_perms_education);
        delete_option($opt_jfb_ask_perms_hometown);
        delete_option($opt_jfb_ask_perms_photos);
        delete_option($opt_jfb_ask_perms_posts);
        delete_option($opt_jfb_ask_perms_relationsship);
        delete_option($opt_jfb_ask_perms_relationsshipdetails);
        delete_option($opt_jfb_ask_perms_religionpolitics);
        delete_option($opt_jfb_ask_perms_videos);
        delete_option($opt_jfb_ask_perms_adsread);
        delete_option($opt_jfb_ask_perms_places);
        delete_option($opt_jfb_ask_perms_friends);
        delete_option($opt_jfb_ask_perms_videoactions);
        delete_option($opt_jfb_ask_perms_events);
        delete_option($opt_jfb_ask_perms_games);
        delete_option($opt_jfb_ask_perms_likes);
        delete_option($opt_jfb_ask_perms_location);
        delete_option($opt_jfb_ask_perms_groups);
        delete_option($opt_jfb_ask_perms_websites);
        delete_option($opt_jfb_ask_perms_work);
        delete_option($opt_jfb_ask_perms_customfreinds);
    ...
    <div class="jfb-admin_wrapper">
        ...
        <div class="<?php echo $allTabsClass ?>" id="<?php echo $tabIds[1]?>" style="display:<?php echo ($shownTab==1?"block":"none")?>">
            ...
            <form name="formMainOptions" method="post" action="">
                ...
                <b><?php _e("Request permission to get the connecting user's", 'wp-fb-autoconnect')?>:</b><br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_email?>" value="1" <?php echo get_option($opt_jfb_ask_perms_email)?'checked="checked"':''?> /> <?php _e("Email address", 'wp-fb-autoconnect')?>
                <?php jfb_output_simple_lightbox("", sprintf(__("Fetching your users' Facebook e-mail addresses will enable the plugin to give new (autoregistered) user accounts a valid e-mail.  However, note that this is only a request - they may still deny permission in the Facebook login popup.  If that happens, their autoregistered user account will be created with a 'placeholder' e-mail %s.<br/><br/>If you would like to require visiters to approve access to their e-mail before they're allowed to login, please check out the 'Request and REQUIRE' option under the Premium tab of the admin panel.", "wp-fb-autoconnect"), '(FB_&lt;user_id&gt;@unknown.com)')) ?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_about?>" value="1" <?php echo get_option($opt_jfb_ask_perms_about)?'checked="checked"':''?> /> <?php _e("About user", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_books?>" value="1" <?php echo get_option($opt_jfb_ask_perms_books)?'checked="checked"':''?> /> <?php _e("Books", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_fitness?>" value="1" <?php echo get_option($opt_jfb_ask_perms_fitness)?'checked="checked"':''?> /> <?php _e("Fitness", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_music?>" value="1" <?php echo get_option($opt_jfb_ask_perms_music)?'checked="checked"':''?> /> <?php _e("Music", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_news?>" value="1" <?php echo get_option($opt_jfb_ask_perms_news)?'checked="checked"':''?> /> <?php _e("News", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_birthday?>" value="1" <?php echo get_option($opt_jfb_ask_perms_birthday)?'checked="checked"':''?> /> <?php _e("Birthday", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_education?>" value="1" <?php echo get_option($opt_jfb_ask_perms_education)?'checked="checked"':''?> /> <?php _e("Education history", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_hometown?>" value="1" <?php echo get_option($opt_jfb_ask_perms_hometown)?'checked="checked"':''?> /> <?php _e("Hometown", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_photos?>" value="1" <?php echo get_option($opt_jfb_ask_perms_photos)?'checked="checked"':''?> /> <?php _e("Photos", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_posts?>" value="1" <?php echo get_option($opt_jfb_ask_perms_posts)?'checked="checked"':''?> /> <?php _e("Posts", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_relationsship?>" value="1" <?php echo get_option($opt_jfb_ask_perms_relationsship)?'checked="checked"':''?> /> <?php _e("Relationships", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_relationsshipdetails?>" value="1" <?php echo get_option($opt_jfb_ask_perms_relationsshipdetails)?'checked="checked"':''?> /> <?php _e("Relationship Details", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_religionpolitics?>" value="1" <?php echo get_option($opt_jfb_ask_perms_religionpolitics)?'checked="checked"':''?> /> <?php _e("Religion Politics", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_videos?>" value="1" <?php echo get_option($opt_jfb_ask_perms_videos)?'checked="checked"':''?> /> <?php _e("Videos", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_adsread?>" value="1" <?php echo get_option($opt_jfb_ask_perms_adsread)?'checked="checked"':''?> /> <?php _e("Ads read", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_places?>" value="1" <?php echo get_option($opt_jfb_ask_perms_places)?'checked="checked"':''?> /> <?php _e("Tagged Places", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_friends?>" value="1" <?php echo get_option($opt_jfb_ask_perms_friends)?'checked="checked"':''?> /> <?php _e("Friends", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_videoactions?>" value="1" <?php echo get_option($opt_jfb_ask_perms_videoactions)?'checked="checked"':''?> /> <?php _e("Video Actions", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_events?>" value="1" <?php echo get_option($opt_jfb_ask_perms_events)?'checked="checked"':''?> /> <?php _e("Events", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_games?>" value="1" <?php echo get_option($opt_jfb_ask_perms_games)?'checked="checked"':''?> /> <?php _e("Games", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_likes?>" value="1" <?php echo get_option($opt_jfb_ask_perms_likes)?'checked="checked"':''?> /> <?php _e("Likes", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_location?>" value="1" <?php echo get_option($opt_jfb_ask_perms_location)?'checked="checked"':''?> /> <?php _e("Location", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_groups?>" value="1" <?php echo get_option($opt_jfb_ask_perms_groups)?'checked="checked"':''?> /> <?php _e("Managed_groups", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_websites?>" value="1" <?php echo get_option($opt_jfb_ask_perms_websites)?'checked="checked"':''?> /> <?php _e("Website", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_work?>" value="1" <?php echo get_option($opt_jfb_ask_perms_work)?'checked="checked"':''?> /> <?php _e("Work history", 'wp-fb-autoconnect')?>
                <br />
                <input type="checkbox" name="<?php echo $opt_jfb_ask_perms_customfreinds?>" value="1" <?php echo get_option($opt_jfb_ask_perms_customfreinds)?'checked="checked"':''?> /> <?php _e("Custom friendlists", 'wp-fb-autoconnect')?>
