...
$opt_jfb_ask_perms_email  = "jfb_ask_permissions_email";
$opt_jfb_ask_perms_about  = "jfb_ask_permissions_about";
$opt_jfb_ask_perms_books  = "jfb_ask_permissions_books";
$opt_jfb_ask_perms_fitness  = "jfb_ask_permissions_fitness";
$opt_jfb_ask_perms_music  = "jfb_ask_permissions_music";
$opt_jfb_ask_perms_news  = "jfb_ask_permissions_news";
$opt_jfb_ask_perms_birthday  = "jfb_ask_permissions_birthday";
$opt_jfb_ask_perms_education  = "jfb_ask_permissions_education";
$opt_jfb_ask_perms_hometown  = "jfb_ask_permissions_hometown";
$opt_jfb_ask_perms_photos  = "jfb_ask_permissions_photos";
$opt_jfb_ask_perms_posts  = "jfb_ask_permissions_posts";
$opt_jfb_ask_perms_relationsship  = "jfb_ask_permissions_relationsship";
$opt_jfb_ask_perms_relationsshipdetails  = "jfb_ask_permissions_relationsshipdetails";
$opt_jfb_ask_perms_religionpolitics  = "jfb_ask_permissions_religionpolitics";
$opt_jfb_ask_perms_videos  = "jfb_ask_permissions_videos";
$opt_jfb_ask_perms_adsread  = "jfb_ask_permissions_adsread";
$opt_jfb_ask_perms_places  = "jfb_ask_permissions_places";
$opt_jfb_ask_perms_friends  = "jfb_ask_permissions_friends";
$opt_jfb_ask_perms_videoactions  = "jfb_ask_permissions_videoactions";
$opt_jfb_ask_perms_events  = "jfb_ask_permissions_events";
$opt_jfb_ask_perms_games  = "jfb_ask_permissions_games";
$opt_jfb_ask_perms_likes  = "jfb_ask_permissions_likes";
$opt_jfb_ask_perms_location  = "jfb_ask_permissions_location";
$opt_jfb_ask_perms_groups  = "jfb_ask_permissions_groups";
$opt_jfb_ask_perms_websites  = "jfb_ask_permissions_websites";
$opt_jfb_ask_perms_work  = "jfb_ask_permissions_work";
$opt_jfb_ask_perms_customfreinds  = "jfb_ask_permissions_customfreinds";
